...
public class KhoaHocDialog extends javax.swing.JDialog {
    ...
    void fillTableChuyenDe(){
        ...
        model.setRowCount(0);
        try {
            ChuyenDe cds = (ChuyenDe) cboChuyenDe.getSelectedItem();
            List<KhoaHoc> list = khdao.selectByChuyenDe(cds.getMaCD());
            for(KhoaHoc kh : list){
                Object[] row = {
                    kh.getMaKH(),
                    kh.getThoiLuong(),
    ...
    void chonChuyenDe(){
        ChuyenDe cds = (ChuyenDe) cboChuyenDe.getSelectedItem();
        txtThoiLuong.setText(String.valueOf(cds.getThoiLuong()));
        txtHocPhi.setText(String.valueOf(cds.getHocPhi()));
        txtChuyenDe.setText(cds.getTenCD());
        txtGhiChu.setText(cds.getTenCD());
    ...
    KhoaHoc getForm(){
        ...
        kh.setNgayKG(DateHelper.toDate(txtKhaiGiang.getText()));
    ...
    void setForm(KhoaHoc kh){
        txtKhaiGiang.setText(DateHelper.toString(kh.getNgayKG()));
    ...
    void next() {
        if (this.row < tblKhoaHoc.getRowCount() - 1) { // getRowCount -1 là dòng cuối
            this.row++;
            this.edit();
        }
    }
